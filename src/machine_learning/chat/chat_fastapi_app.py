...
async def query(request: Request):
    ...
    prompt_template = """You are a chatbot employed in aiding helping public sector workers understanding refugee needs. Use the following pieces of context, which is based on Telegram messages from Ukrainian refugees to answer the question at the end. 
